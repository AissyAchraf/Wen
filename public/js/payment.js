Stripe.setPublishableKey('pk_test_51NXjZCHR3CBwpLK6eiI6uIYAhunb3Kn6zRvFODXt84VTbUgNDGQy99aQieF9nTuhXzrN0iGCY0FWWByVxO5ioFNU00mYz0QO36');
...
function stripeResponseHandler(status, response) {
 if(response.error) {
  ...
  $('#cardsPaymentForm').append("<input type='hidden' name='stripeToken' value='" + stripeToken + "' />");

  $('#cardsPaymentForm').submit();
 }
}
